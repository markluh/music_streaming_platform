"""
Django settings for music_platform_project project.
...
SECRET_KEY = 'django-insecure-g_ob220(*5yx_29bv4_b8exomm+j2&vf7$bjt8harc%q@^u(nm'
...
WSGI_APPLICATION = 'music_platform_project.wsgi.application'
